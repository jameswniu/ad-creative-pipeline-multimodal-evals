...
<img alt="thresholds traced to those grades: 10 of 10, and 10 of 10 named gating thresholds derived from labelled exemplars" src="https://img.shields.io/badge/thresholds_traced_to_grades-10%2F10_derived-6f4a8f?style=flat-square&labelColor=18181c">
...
```mermaid
%%{init: {'flowchart': {'curve': 'linear', 'nodeSpacing': 28, 'rankSpacing': 34, 'padding': 8, 'subGraphTitleMargin': {'top': 6, 'bottom': 14}}, 'themeVariables': {'fontSize': '18px', 'lineColor': '#8a8d96', 'edgeLabelBackground': '#ffffff', 'clusterBkg': '#f4f4f7', 'clusterBorder': '#8a8d96', 'titleColor': '#18181c'}}}%%
flowchart TD
    ...
    classDef run fill:#26252c,stroke:#8a8d96,color:#e6e6ec
    classDef process fill:#26252c,stroke:#8ab8e0,stroke-width:2px,color:#e6e6ec
    classDef outcome fill:#26252c,stroke:#c9a86a,stroke-width:2px,color:#e6e6ec
    classDef vibe fill:#26252c,stroke:#bd93dc,stroke-width:2px,color:#e6e6ec
    class R,D,L run
    class P,B,C,SG process
    class O,BU,AG outcome
    class V,EYE vibe
    style OWN fill:#f4f4f7,stroke:#8a8d96,color:#18181c
    style RUN fill:#f4f4f7,stroke:#8a8d96,color:#18181c
```
