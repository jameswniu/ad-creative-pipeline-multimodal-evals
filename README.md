...
<img alt="ad versions: 28, across 4 video engines" src="https://img.shields.io/badge/ad_versions-28_across_4_engines-d4b56a?style=flat-square&labelColor=1a1918">
<img alt="spec ads: 10, for real products" src="https://img.shields.io/badge/spec_ads-10_for_real_products-55595e?style=flat-square&labelColor=1a1918">
<img alt="spend: every render gated first" src="https://img.shields.io/badge/spend-every_render_gated_first-55595e?style=flat-square&labelColor=1a1918">
<img alt="graded by hand: 48 exemplars, 42 scenes" src="https://img.shields.io/badge/graded_by_hand-48_exemplars_%C2%B7_42_scenes-55595e?style=flat-square&labelColor=1a1918">
<img alt="thresholds traced to those grades: 10 of 10, and 10 of 10 named gating thresholds derived from labelled exemplars" src="https://img.shields.io/badge/thresholds_traced_to_grades-10%2F10_derived-6b6f75?style=flat-square&labelColor=1a1918">
<img alt="license: Apache-2.0" src="https://img.shields.io/badge/license-Apache--2.0-55595e?style=flat-square&labelColor=1a1918">
...
<table>
  <tr>
    <td width="50%" align="center" valign="top"><img src="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-cell-pics.gif" alt="Google Pics spec ad" width="100%"><br><b>Google Pics.</b> The photo is almost right, and almost is the thing that ruins it. <a href="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-pics.mp4">&#9654; with sound</a></td>
    <td width="50%" align="center" valign="top"><img src="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-cell-gemini.gif" alt="Gemini spec ad" width="100%"><br><b>Gemini.</b> Your head has forty tabs open and not one of them is labelled. <a href="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-gemini.mp4">&#9654; with sound</a></td>
  </tr>
</table>

<table>
  <tr>
    <td width="50%" align="center" valign="top"><img src="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260830-cell-zai.gif" alt="Z.ai spec ad" width="100%"><br><b>Z.ai.</b> Her studio apartment is smaller than the problem she's solving. <a href="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260830-zai.mp4">&#9654; with sound</a></td>
    <td width="50%" align="center" valign="top"><img src="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260830-cell-kimi.gif" alt="Kimi spec ad" width="100%"><br><b>Kimi.</b> She has one question and a library's worth of everything else. <a href="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260830-kimi.mp4">&#9654; with sound</a></td>
  </tr>
</table>

<table>
  <tr>
    <td width="50%" align="center" valign="top"><img src="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-cell-chatgpt.gif" alt="ChatGPT spec ad" width="100%"><br><b>ChatGPT.</b> It is never the big decisions that eat the evening. <a href="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-chatgpt.mp4">&#9654; with sound</a></td>
    <td width="50%" align="center" valign="top"><img src="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-cell-perplexity.gif" alt="Perplexity spec ad" width="100%"><br><b>Perplexity.</b> Four hundred tabs, ten blue links, and still no answer. <a href="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-perplexity.mp4">&#9654; with sound</a></td>
  </tr>
</table>

<table>
  <tr>
    <td width="50%" align="center" valign="top"><img src="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-cell-metaai.gif" alt="Meta AI spec ad" width="100%"><br><b>Meta AI.</b> Some days the list unrolls right out the front door. <a href="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260827-metaai.mp4">&#9654; with sound</a></td>
    <td width="50%" align="center" valign="top"><img src="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260830-cell-grok.gif" alt="Grok spec ad" width="100%"><br><b>Grok.</b> The whole street changes its mind three times before your coffee cools. <a href="https://github.com/jameswniu/ad-creative-pipeline-multimodal-evals/releases/download/media-2026-08/shoot-20260830-grok.mp4">&#9654; with sound</a></td>
  </tr>
</table>
...
The same loop as a graph, with what the figure leaves out: the fail edges, the eye, the ledger closing the loop, and which tier owns each gate.

```mermaid
%%{init: {'flowchart': {'curve': 'linear', 'nodeSpacing': 28, 'rankSpacing': 34, 'padding': 8, 'subGraphTitleMargin': {'top': 6, 'bottom': 14}}, 'themeVariables': {'fontSize': '18px', 'lineColor': '#8f7a45', 'edgeLabelBackground': '#ffffff', 'clusterBkg': '#faf9f6', 'clusterBorder': '#8f7a45', 'titleColor': '#1a1918'}}}%%
flowchart TD
    subgraph OWN["Who owns the gate · each tier answers to its own source of truth"]
        direction LR
        P["1 Process · Board, Closer, Ship gate"]
        O["2 Outcome · Build, Ad gates"]
        V["3 Vibe · Ad gates, the eye"]
    end

    subgraph RUN["The run · every request and landing ledgered"]
        direction TB
        B["Board"] --> R["Render"] --> C["Closer"] --> BU["Build"] --> AG{"Ad gates"} --> SG{"Ship gate"} --> D["Deliver"]
    end

    EYE["The eye · the only human in the loop"]
    L[("Ledger · append-only")]

    P ~~~ B
    O ~~~ B
    V ~~~ B
    AG -->|"blocks delivery · re-roll"| R
    AG -->|"REVIEW · handed to the eye"| EYE
    EYE -->|"eye approved"| SG
    SG -->|"fails closed · remaster"| BU
    D --> L
    L -.->|"relabel · re-derive the thresholds"| B

    classDef run fill:#262422,stroke:#8f7a45,color:#f2efe9
    classDef process fill:#262422,stroke:#c9ccd1,stroke-width:2px,color:#f2efe9
    classDef outcome fill:#262422,stroke:#d9a08c,stroke-width:2px,color:#f2efe9
    classDef vibe fill:#262422,stroke:#d4b56a,stroke-width:2px,color:#f2efe9
    class R,D,L run
    class P,B,C,SG process
    class O,BU,AG outcome
    class V,EYE vibe
    style OWN fill:#faf9f6,stroke:#8f7a45,color:#1a1918
    style RUN fill:#faf9f6,stroke:#8f7a45,color:#1a1918
```
