...
```mermaid
%%{init: {'flowchart': {'curve': 'linear', 'nodeSpacing': 28, 'rankSpacing': 34, 'padding': 20}, 'themeVariables': {'fontSize': '18px', 'lineColor': '#8f7a45', 'edgeLabelBackground': '#ffffff', 'clusterBkg': '#faf9f6', 'clusterBorder': '#8f7a45', 'titleColor': '#1a1918'}}}%%
flowchart TD
